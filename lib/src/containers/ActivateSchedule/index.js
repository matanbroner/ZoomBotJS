...
class ActivateSchedule extends React.Component{
    ...
    async componentDidMount(){
        let schedules = await this.props.schedules;
      ...
      if(schedule){
        return(
          ...
          <Table>
            ...
            <tbody>
              {this.sortMeetingsByJoinTime(schedule.meetings).map(meeting => (
      ...
      return(
        <div className={localStyles.scheduleCell}>
          ...
          <div className={localStyles.cellButtonRow}>
            ...
            <div className={localStyles.cellButton} id={localStyles.cellActivateButton}>
            <FontAwesomeIcon icon={faPowerOff}/>
            </div>
          </div>
        </div>
